...
export default function PromptComposer({ onSubmit, onSubmitWithFile, onStop, disabled, pinned, activeJobId }) {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 760 }}>
      ...
      {/* Input box */}
      <div className={focused ? "glass-panel neon-pulse" : "glass-panel"} style={{
        borderRadius: 16, padding: '12px 16px 10px',
        transition: 'border-color 0.15s, box-shadow 0.15s',
        borderColor: focused ? 'var(--violet)' : file ? 'rgba(45,212,191,0.3)' : 'var(--border)',
        boxShadow: focused
          ? '0 0 0 3px rgba(167,139,250,0.12), 0 8px 32px rgba(0,0,0,0.3)'
          : file
